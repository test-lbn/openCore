...
divTag.id = "loadingMessage";
divTag.setAttribute("align","center");
divTag.style.position="fixed"
divTag.style.top="-120px";
divTag.style.left="30px";
/*divTag.style.marginLeft="px";
divTag.style.marginTop= "-45px";*/
divTag.style.width= "320px";
divTag.style.height= "305px";
divTag.style.background="url(libs/xajax/xajax_core/cargando.gif) no-repeat top left";
...
{
//alert("Xajax Error...HTTP status code: " + args.request.status + '\n\n'+ args.request.responseText); //estatus
toastr.error("Xajax Error...HTTP status code: " + args.request.status + '\n\n<div>'+ args.request.responseText+'</div>'); //estatus
}
